...
export const pageMeta: Record<string, PageMetaEntry> = {
  ...
  "/services": {
    title: "Our Taxi Services in Vizag",
  ...
  "/services/outstation-taxi": {
    ...
    keywords: ["outstation taxi vizag", "one way cab visakhapatnam"],
  },
  ...
  "/destinations": {
    title: "Top Destinations Near Vizag",
  ...
  "/about": {
    title: "About Us",
    description: "Learn about BSH Taxi Services, a trusted transportation company based in Vizag.",
    keywords: ["about bsh taxi services"],
  },
  "/contact": {
    title: "Contact Us",
    description: "Get in touch with BSH Taxi Services for bookings, queries, and support.",

...
/*  styling below now mirrors ServiceDetails.tsx (gradient badges,    */
/*  ring-slate-100 cards, same hover/shadow treatment) so both pages  */
/*  feel like one product, just with Local Taxi's own hero/palette.   */
/*                                                                    */
...
export default function LocalTaxi() {
  ...
  return (
    <>
      ...
      {/* ---------------------------------------------------------- */}
      {/* Hero — dark band, distinct from the light ServiceDetails hero */}
      {/* ---------------------------------------------------------- */}
      <section className="relative overflow-hidden bg-slate-950 pt-24">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 pb-16 pt-10 lg:px-10">
          <nav className="mb-8 flex items-center gap-2 text-xs font-medium text-slate-400">
            ...
            <span>/</span>
            <span className="text-slate-200">Local Taxi</span>
          </nav>

          <span className="inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-amber-300">
            <Sparkles size={14} />
            Local Taxi in Vizag
          </span>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-amber-400 px-8 py-4 font-bold text-slate-900 shadow-lg shadow-amber-400/20 transition-all duration-300 hover:-translate-y-1 hover:bg-amber-300"
            >
              Book This Package
              <ArrowRight size={18} />
            </button>
